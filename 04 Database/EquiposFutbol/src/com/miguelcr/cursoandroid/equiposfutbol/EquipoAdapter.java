...
public class EquipoAdapter extends ArrayAdapter<Equipo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageView escudoEquipo = (ImageView) convertView.findViewById(R.id.imageViewEscudo);
			int refDrawable = contexto.getResources()
					.getIdentifier(itemActual.getEscudo(), "drawable", contexto.getPackageName());
			escudoEquipo.setImageResource(refDrawable);
			
			TextView nombreEquipo = (TextView) convertView.findViewById(R.id.textViewNombreEquipo);
			nombreEquipo.setText(itemActual.getNombre());
